...
@Component({
  ...
  template: `
    <sj-host asCard [cardVariant]="sj.sjCard.variants.outlined" [sj]="[ sj.mt(0) ]">
      ...
      @if (code) {
        <div [sj]="[ sj.mt(0.5), sj.d('flex'), sj.fxDir(sj.fxDir.options.row), sj.gap(0.5) ]">
          <sj-button [variant]="sj.sjButton.variants.outlined" [sj]="{ px: 0.5, py: 0.25 }" (click)="toggle()">
