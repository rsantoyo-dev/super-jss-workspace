import { AfterContentInit, Component, ElementRef, Renderer2, ViewContainerRef } from '@angular/core';
...
export class SjHostComponent extends SjDirective implements AfterContentInit {
  constructor(
