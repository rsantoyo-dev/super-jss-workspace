...
Components like `sj-card` are convenient wrappers around the core `[sj]` directive. For full control and customization, use the directive directly. Learn more in the [Core Directive](/docs/core/directive) section.
:::
